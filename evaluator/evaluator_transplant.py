...
def main():
    ...
    parser.add_argument("--sample_path", default="/projects/yuanai/projects/Discrete-Categorical-Tokenizer/reconstruction/Transplant/ImageNet/", help="path to sample batch npz file")
    parser.add_argument("--sample_name", default="DCT_False_64.npz", help="path to sample batch npz file")
    args = parser.parse_args()
    args.sample_batch =  os.path.join(args.sample_path, args.sample_name)
    print("sample_batch:", args.sample_batch)
